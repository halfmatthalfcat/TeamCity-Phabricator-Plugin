...
public final class HttpRequestBuilder {
    ...
    public HttpRequestBuilder setScheme(String scheme){
        if(isNullOrEmpty(scheme)) throw new IllegalArgumentException("Must provide a valid scheme");
    ...
    public HttpRequestBuilder setHost(String host){
        if(isNullOrEmpty(host)) throw new IllegalArgumentException("Must provide a valid host");
        else this.host = host;
        return this;
    }
    ...
    public HttpRequestBuilder setPath(String path){
        if(isNullOrEmpty(path)) throw new IllegalArgumentException("Must provide a valid path");
        else this.path = path;
        return this;
    }
    ...
    public HttpRequestBuilder setBody(String body) throws UnsupportedEncodingException {
        if(isNullOrEmpty(body)) throw new IllegalArgumentException("Must provide a valid body");
    ...
    public HttpRequestBase build() throws TCPhabException, URISyntaxException {
        ...
        if(isNullOrEmpty(scheme)) throw new TCPhabException("Must provide a scheme");
        if(isNullOrEmpty(host)) throw new TCPhabException("Must provide a host");
        if(port == null) this.port = 80;
        if(isNullOrEmpty(path)) throw new TCPhabException("Must provide a path");
